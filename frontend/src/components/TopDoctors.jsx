...
const TopDoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-a6 text-gray-900 md:mx-10'>
        ...
        <button onClick={()=>navigate('/doctors'). scrollTo(0,0) } className='bg-blue-50 rounded-full text-gray-600 px-12 py-3 mt-10'>More</button>
    </div>
  )
}
